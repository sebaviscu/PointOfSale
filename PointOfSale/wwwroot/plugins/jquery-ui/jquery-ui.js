...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		monthNames: [ "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio",
			"Julio", "Agosto", "Semptiembre", "Octubre", "Noviembre", "Diciembre" ], // Names of months for drop-down and formatting
		monthNamesShort: [ "Ene", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic" ], // For formatting
		dayNames: ["Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado", "Domingo" ], // For formatting
		...
		selectMonthLabel: "Seleccione mes", // Invisible label for month selector
		selectYearLabel: "Seleccione año" // Invisible label for year selector
	};
